...
<form:form action="${signUpUrl}" method="post" modelAttribute="signupForm">
    <div class="container-fluid" id="main-container">
        <div class="container box">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-white"><spring:message code="signUp.pageTitle"/></h1>
                    <p class="text-white"><spring:message code="signUp.pageTitleText"/></p>
                </div>
                <div class="col-12 col-md-6">
                    <form:errors path="firstname" cssClass="alert alert-warning" element="p"/>
                    <spring:message code="signUp.firstNamePh" var="firsnamePh"/>
                    <form:input type="text" placeholder="${firsnamePh}" name="firstname" path="firstname"/>

                    <form:errors path="lastname" cssClass="alert alert-warning" element="p"/>
                    <spring:message code="signUp.lastNamePh" var="lastnamePh"/>
                    <form:input type="text" placeholder="${lastnamePh}" name="lastname" path="lastname"/>
        ...
        <div class="container signin">
            <p>
                <spring:message code="signUp.haveAcc"/>
                <a href="${signInURL}">
