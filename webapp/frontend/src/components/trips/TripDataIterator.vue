<template>
	...
	>
		...
		<template v-if="hasMoreThanOnePage" v-slot:footer>
...
export default {
	...
	computed: {
		...
		itemsPerPage() {
			return this.link ? parseInt(this.link.first.perPage) : 0;
		},
		hasMoreThanOnePage() {
			return this.link && this.link.first.page !== this.link.last.page;
		},
	},
	methods: {
		nextPage() {
